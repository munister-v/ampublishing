import { Book, NewsItem, Region, Language, BookVariant, Order, BookStory, LocalizedCatalogData, ServicesContent } from './types';
...
// Значения по умолчанию. Клиент правит их в админке → сохраняется
// в public/content/services.<lang>.json и перекрывает эти дефолты.

export const DEFAULT_SERVICES: Record<Language, ServicesContent> = {
  ru: {
    title: 'Услуги',
    subtitle: 'Издательская поддержка автора — от рукописи до готовой книги.',
    intro: 'Мы работаем с авторами индивидуально: подбираем формат сотрудничества под конкретный текст, объём и задачу. Стоимость каждой услуги рассчитывается персонально после знакомства с рукописью.',
    items: [
      {
        id: 'publishing',
        title: 'Издание книги под ключ',
        summary: 'Полный цикл: от рукописи до готового тиража.',
        includes: [
          'Оценка рукописи и издательский план',
          'Редактура, корректура, вёрстка',
          'Дизайн обложки и подготовка макета к печати',
          'Присвоение ISBN и выходные данные',
          'Печать тиража и передача автору',
        ],
        note: 'Сроки зависят от объёма рукописи — обсуждаем на старте.',
      ...
      },
      {
        ...
        summary: 'Работа с текстом без изменения авторского голоса.',
        includes: [
          'Литературная редактура',
          'Корректура — орфография, пунктуация, единообразие',
          'Комментарии редактора по структуре текста',
          'Один круг правок после согласования',
        ],
        note: '',
        priceNote: 'Расчёт индивидуальный',
        enabled: true,
      ...
      {
        id: 'design',
        title: 'Дизайн обложки и вёрстка',
        summary: 'Визуальное решение книги.',
        includes: [
          'Концепция и эскизы обложки',
          'Финальная обложка в печатном и цифровом формате',
      ...
      },
      {
        id: 'printing',
        title: 'Печать тиража',
        summary: 'Печать книги любым тиражом.',
        includes: [
          'Подбор бумаги, переплёта и формата',
          'Цифровая или офсетная печать',
          'Контроль качества тиража',
          'Отгрузка и доставка',
        ],
        note: '',
        priceNote: 'Расчёт индивидуальный',
      ...
      {
        id: 'promotion',
        title: 'Продвижение и дистрибуция',
        summary: 'Чтобы книгу увидели и купили.',
        includes: [
          'Размещение книги в каталоге издательства',
          'Презентация книги и участие в мероприятиях',
          'Анонсы в соцсетях и на радио издательства',
          'Помощь с выходом на площадки продаж',
        ],
        note: '',
        priceNote: 'Расчёт индивидуальный',
        enabled: true,
    ...
    orderIntro: 'Напишите нам письмо — мы ответим с предварительным расчётом и планом работы.',
    orderChecklist: [
      'Название услуги, которая вас интересует',
      'Имя и как с вами связаться',
      'Кратко о рукописи: жанр, объём (страниц или знаков), готовность текста',
      'Желаемые сроки и тираж, если он уже понятен',
      'Файл рукописи или фрагмент — если готовы его прислать',
    ],
    contactEmail: 'info@ampublishing.org',
  ...
  en: {
    title: 'Services',
    subtitle: 'Publishing support for authors — from manuscript to finished book.',
    intro: 'We work with every author individually and shape the collaboration around the specific text, length and goal. The price of each service is calculated personally once we have seen the manuscript.',
    items: [
      {
        id: 'publishing',
        title: 'Full-cycle book publishing',
        summary: 'Everything from manuscript to printed copies.',
        includes: [
          'Manuscript assessment and publishing plan',
          'Editing, proofreading, typesetting',
          'Cover design and print-ready layout',
          'ISBN and imprint details',
          'Print run and delivery to the author',
        ],
        note: 'Timelines depend on the length of the manuscript — we agree on them at the start.',
        priceNote: 'Individual quote',
        enabled: true,
      },
      {
        id: 'editing',
        title: 'Editing and proofreading',
        summary: 'Working with the text without changing the author’s voice.',
        includes: [
          'Literary editing',
          'Proofreading — spelling, punctuation, consistency',
          'Editor’s notes on the structure of the text',
          'One round of revisions after approval',
        ],
        note: '',
        priceNote: 'Individual quote',
        enabled: true,
      },
      {
        ...
        summary: 'The visual identity of your book.',
        includes: [
          'Cover concept and sketches',
          'Final cover in print and digital formats',
      ...
      },
      {
        id: 'printing',
        title: 'Printing',
        summary: 'Print runs of any size.',
        includes: [
          'Choice of paper, binding and format',
          'Digital or offset printing',
          'Quality control of the print run',
      ...
      },
      {
        ...
        summary: 'So the book is seen and bought.',
        includes: [
          'Your book in the publisher’s catalogue',
          'Book presentations and events',
          'Announcements on social media and the publisher’s radio',
          'Support in reaching retail platforms',
        ],
        note: '',
        priceNote: 'Individual quote',
        enabled: true,
    ...
    orderIntro: 'Send us an email — we will reply with a preliminary quote and a work plan.',
    orderChecklist: [
      'The name of the service you are interested in',
      'Your name and how to reach you',
      'A short description of the manuscript: genre, length, how finished it is',
      'Preferred timeline and print run, if you already know them',
      'The manuscript or an excerpt — if you are ready to share it',
    ],
    contactEmail: 'info@ampublishing.org',
  ...
  de: {
    ...
    subtitle: 'Verlagsbegleitung für Autorinnen und Autoren — vom Manuskript bis zum fertigen Buch.',
    intro: 'Wir arbeiten mit jedem Autor individuell und richten die Zusammenarbeit am konkreten Text, Umfang und Ziel aus. Der Preis jeder Leistung wird persönlich kalkuliert, nachdem wir das Manuskript gesehen haben.',
    items: [
      {
        id: 'publishing',
        title: 'Buchproduktion — Komplettpaket',
        summary: 'Alles vom Manuskript bis zur gedruckten Auflage.',
        includes: [
          'Manuskriptbewertung und Verlagsplan',
          'Lektorat, Korrektorat, Satz',
          'Covergestaltung und druckfertiges Layout',
          'ISBN und Impressum',
          'Druck der Auflage und Übergabe an den Autor',
        ],
        note: 'Die Zeitplanung hängt vom Umfang des Manuskripts ab — wir stimmen sie zu Beginn ab.',
        priceNote: 'Individuelle Kalkulation',
        enabled: true,
      },
      {
        id: 'editing',
        title: 'Lektorat und Korrektorat',
        summary: 'Arbeit am Text, ohne die Stimme des Autors zu verändern.',
        includes: [
          'Literarisches Lektorat',
          'Korrektorat — Rechtschreibung, Zeichensetzung, Einheitlichkeit',
          'Anmerkungen der Redaktion zur Textstruktur',
          'Eine Korrekturrunde nach Abstimmung',
        ],
        note: '',
        priceNote: 'Individuelle Kalkulation',
        enabled: true,
      ...
      {
        id: 'design',
        title: 'Covergestaltung und Satz',
        summary: 'Die visuelle Gestalt Ihres Buches.',
        includes: [
          'Coverkonzept und Entwürfe',
          'Finales Cover für Druck und digitale Ausgabe',
          'Satz des Innenteils',
          'Druckfertige Dateien für die Druckerei',
        ],
        note: '',
        priceNote: 'Individuelle Kalkulation',
        enabled: true,
      ...
      {
        id: 'printing',
        title: 'Druck der Auflage',
        summary: 'Auflagen in jeder Größe.',
        includes: [
          'Auswahl von Papier, Bindung und Format',
          'Digital- oder Offsetdruck',
          'Qualitätskontrolle der Auflage',
      ...
      {
        id: 'promotion',
        title: 'Promotion und Vertrieb',
        summary: 'Damit das Buch gesehen und gekauft wird.',
        includes: [
          'Ihr Buch im Katalog des Verlags',
          'Buchpräsentationen und Veranstaltungen',
          'Ankündigungen in den sozialen Medien und im Verlagsradio',
          'Unterstützung beim Zugang zu Verkaufsplattformen',
        ],
        note: '',
        priceNote: 'Individuelle Kalkulation',
        enabled: true,
    ...
    orderIntro: 'Schreiben Sie uns eine E-Mail — wir antworten mit einer ersten Kalkulation und einem Arbeitsplan.',
    orderChecklist: [
      'Die gewünschte Leistung',
      'Ihr Name und wie wir Sie erreichen',
      'Kurz zum Manuskript: Genre, Umfang, Fertigstellungsgrad',
      'Wunschtermin und Auflagenhöhe, sofern schon bekannt',
      'Das Manuskript oder eine Leseprobe — falls Sie sie teilen möchten',
    ],
    contactEmail: 'info@ampublishing.org',
