...
export const translations: Record<Language, TranslationTree> = {
  ru: {
    ...
    home: {
      ...
      global_reach: "Живой каталог",
      global_desc: "Показатели формируются автоматически из книг, опубликованных в каталоге.",
      stats_countries: "Книг в каталоге",
      stats_delivery: "Авторов",
    ...
    product: {
      ...
      buy_on_shopify: "Купить на Shopify",
      make_preorder: "Оформить предзаказ",
      buy_in_shop: "Купить в магазине",
      preorder_in_shop: "Предзаказать в магазине",
      price_in_shop: "Актуальная цена в магазине",
      shop_checkout_note: "Оплата, доставка и корзина откроются на shop.ampublishing.org",
      purchase: "Покупка",
      available_in_shop: "Доступно в магазине",
      ...
      themes: "Темы романа",
      excerpt: "Отрывок",
      excerpt_end: "Продолжение — в книге",
      author_section: "Об авторе",
      reviews: "Читатели о книге",
      buy_elsewhere_title: "Также в продаже",
      payment_info_title: "Оплата и доставка",
      payment_info_text: "Покупка, оплата и расчёт доставки проходят в официальном магазине AM Publishing. После нажатия кнопки откроется страница выбранной книги.",
    ...
    services: {
      ...
      static: {
        ...
        privacy: {
            ...
            sections: [
                ...
                { 
                    ...
                    text: "Наш сайт использует файлы cookie и локальное хранилище. Они нужны для сохранения технических настроек, например выбранного языка, согласия на cookie или статуса входа в административную часть.\n\nПокупка книг проходит в отдельном магазине shop.ampublishing.org, где действуют собственные настройки cookie и политика конфиденциальности. Вы можете ограничить или удалить cookie в настройках браузера."
                },
                { 
        ...
        media: {
          title: "Мероприятия",
          subtitle: "События, презентации и новости издательства AM Publishing.",
          empty: "Пока нет мероприятий.",
          kit_title: "Пресс-кит",
  ...
  en: {
    ...
    product: {
      ...
      buy_on_shopify: "Buy on Shopify",
      make_preorder: "Preorder Now",
      buy_in_shop: "Buy in the shop",
      preorder_in_shop: "Preorder in the shop",
      price_in_shop: "Current price in the shop",
      shop_checkout_note: "Cart, payment, and delivery open on shop.ampublishing.org",
      purchase: "Purchase",
      available_in_shop: "Available in the shop",
      back_to_catalog: "Back to catalog",
        ...
        themes: "Themes",
        excerpt: "Excerpt",
        excerpt_end: "Continues in the book",
        author_section: "About the author",
        reviews: "Readers on the book",
        buy_elsewhere_title: "Also available at",
        payment_info_title: "Payment and shipping",
        payment_info_text: "Purchase, payment, and delivery are handled by the official AM Publishing shop. The selected book page opens when you continue.",
        ...
        ask_price: "Request price",
        spread_prev: "Back",
        spread_next: "Next",
        spread_of: "of",
        open_card: "View details",
    ...
    home: {
      ...
      marquee_h: "The Art of Publishing • Depth of Thought • Psychological Insight • Humanity • ",
      global_reach: "Live Catalog",
      global_desc: "These figures are calculated automatically from the books currently published in the catalog.",
      stats_countries: "Books in catalog",
      stats_delivery: "Authors",
      stats_countries_value: "59",
      stats_delivery_value: "24-120h",
      hero_image: `${import.meta.env.BASE_URL}images/home-hero.webp`,
      feature_image: `${import.meta.env.BASE_URL}images/home-feature.webp`,
    ...
    static: {
        ...
        privacy: {
            ...
            sections: [
                ...
                { 
                    title: "7. Cookies", 
                    text: "This editorial website uses technically necessary cookies and local storage for preferences such as language, consent, and administrator sign-in.\n\nBook purchases take place on the separate shop.ampublishing.org storefront, where the shop's own cookie and privacy information applies. Analytics or marketing cookies are loaded here only when enabled and consented to."
                },
                { 
        ...
        media: {
          title: "Events",
          subtitle: "Events, book launches, and news from AM Publishing.",
          empty: "No events yet.",
          kit_title: "Press Kit",
  ...
  de: {
    ...
    product: {
      ...
      buy_on_shopify: "Bei Shopify kaufen",
      make_preorder: "Jetzt vorbestellen",
      buy_in_shop: "Im Shop kaufen",
      preorder_in_shop: "Im Shop vorbestellen",
      price_in_shop: "Aktueller Preis im Shop",
      shop_checkout_note: "Warenkorb, Zahlung und Versand öffnen sich auf shop.ampublishing.org",
      purchase: "Kauf",
      available_in_shop: "Im Shop erhältlich",
      back_to_catalog: "Zurück zum Katalog",
        ...
        themes: "Themen",
        excerpt: "Auszug",
        excerpt_end: "Weiter im Buch",
        author_section: "Über den Autor",
        reviews: "Leserstimmen",
        buy_elsewhere_title: "Auch erhältlich bei",
        payment_info_title: "Zahlung und Versand",
        payment_info_text: "Kauf, Zahlung und Versand werden im offiziellen AM Publishing Shop abgewickelt. Beim Fortfahren öffnet sich die Seite des ausgewählten Buches.",
        ...
        ask_price: "Preis anfragen",
        spread_prev: "Zurück",
        spread_next: "Weiter",
        spread_of: "von",
        open_card: "Details ansehen",
    ...
    home: {
      ...
      marquee_h: "The Art of Publishing • Depth of Thought • Psychological Insight • Humanity • ",
      global_reach: "Aktueller Katalog",
      global_desc: "Diese Zahlen werden automatisch aus den aktuell veröffentlichten Büchern berechnet.",
      stats_countries: "Bücher im Katalog",
      stats_delivery: "Autor:innen",
      stats_countries_value: "59",
      stats_delivery_value: "24-120h",
      hero_image: `${import.meta.env.BASE_URL}images/home-hero.webp`,
      feature_image: `${import.meta.env.BASE_URL}images/home-feature.webp`,
    ...
    static: {
        ...
        privacy: {
            ...
            sections: [
                ...
                { 
                    title: "7. Cookies", 
                    text: "Diese redaktionelle Website verwendet technisch notwendige Cookies und lokalen Speicher für Einstellungen wie Sprache, Einwilligung und die Anmeldung im Administrationsbereich.\n\nBuchkäufe erfolgen im separaten Shop unter shop.ampublishing.org; dort gelten die eigenen Cookie- und Datenschutzhinweise des Shops. Analyse- oder Marketing-Cookies werden hier nur nach Aktivierung und Einwilligung geladen."
                },
                { 
        ...
        media: {
          ...
          subtitle: "Veranstaltungen, Buchpremieren und Neuigkeiten von AM Publishing.",
