...
const ServiceBlock: React.FC<{
  ...
  ctaLabel: string;
}> = ({ item, index, email, subjectTemplate, ctaLabel }) => (
  <article className="bg-white border border-primary/15 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
    ...
    <div className="p-8 lg:p-12 flex flex-col gap-8">
      ...
      <a
        ...
        className="mt-auto self-start inline-flex items-center gap-3 border border-primary px-6 py-3 text-[10px] uppercase tracking-[0.22em] font-bold hover:bg-primary hover:text-white transition-colors group"
      >
        {ctaLabel}
...
export const ServicesPage: React.FC = () => {
  const { services, isLoadingData } = useApp();
